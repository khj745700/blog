...
public interface BoardRepository extends JpaRepository<Board, Integer> {
    ...
    @Query("SELECT new shop.khj745700.backend.domain.board.rest.dto.BoardView(b) FROM Board b WHERE b.wroteDate != null AND b.isHidden = false ORDER BY b.wroteDate DESC ")
